...
import {
  getFixtureBranches,
  getFixtureCommits,
  getFixtureCommitStats,
  getFixtureDiff,
  toRepoStats,
} from "./github-fixtures";

const isMockGitHub = () => process.env.GITHUB_API_MODE === "mock";
...
export async function fetchCommitStats(
  ...
  if (isMockGitHub()) {
    return getFixtureCommitStats()[sha] ?? { additions: 0, deletions: 0 };
  }
