 ...
 * Helper functions for generating patch note boilerplate
 */

import { formatFilterDetailLabel, getPresetLabel } from '@/lib/filter-utils';
import type { PatchNoteFilters, RepoStats } from '../types';
