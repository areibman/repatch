...
export async function POST(
  ...
  try {
    ...
    const { provider, supabase, runtimeConfig } =
      await resolveActiveEmailProvider();
...
<body>
  <div class="container">
    ...
    const fromEmail =
      runtimeConfig.resend?.fromEmail ??
      runtimeConfig.customerio?.fromEmail ??
      "Repatch <updates@repatch.dev>";
