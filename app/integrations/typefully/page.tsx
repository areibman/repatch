    ...
    <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Queue your patch notes as Twitter threads with optional video uploads.
            </p>
          </div>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Repatch uses your Typefully API key to create and schedule Twitter threads.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <ul className="list-disc pl-6 space-y-2 text-sm text-muted-foreground">
            <li>Create Twitter threads from your patch notes</li>
            <li>Include auto-generated videos in your threads</li>
            <li>Schedule posts for optimal engagement times</li>
            <li>Works directly from each patch note page</li>
            <li>Track publishing status and thread URLs</li>
          </ul>
        </CardContent>
