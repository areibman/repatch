    ...
    <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Queue Twitter threads for your patch notes with automatic video teasers.
            </p>
          </div>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Repatch uses your Typefully credentials to queue polished Twitter threads with Remotion videos attached.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <ul className="list-disc pl-6 space-y-2 text-sm text-muted-foreground">
            <li>Reuse your patch note content for ready-to-post Twitter threads.</li>
            <li>Automatically render a Remotion video teaser for the first post.</li>
            <li>Track thread queue status directly from the patch note page.</li>
          </ul>
        </CardContent>
