      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
          <Card>
            ...
            <CardContent>
              <div data-testid="total-posts" className="text-3xl font-bold">
                {patchNotes.length}
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div data-testid="repository-count" className="text-3xl font-bold">
          ...
          <Card>
            ...
            <CardContent>
              <div data-testid="posts-this-month" className="text-3xl font-bold">
                {
                  patchNotes.filter((p) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {patchNotes.map((note) => (
            <Link key={note.id} href={`/blog/${note.id}`}>
              <Card
                data-testid={`patch-note-card-${note.id}`}
